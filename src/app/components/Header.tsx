    ...
    <header className="header-wrapper">
      <div className="container">
        <nav className="navbar">
          ...
          {/* Desktop Navigation */}
          <div className="header-actions desktop-only" style={{ display: 'flex', alignItems: 'center', gap: '1rem', transform: 'translateX(3rem)' }}>
              ...
              <ul className="nav-links">
                ...
                <li className="nav-dropdown-parent">
                  ...
                  <div className="nav-dropdown">
                    ...
                    <Link href="/servicios/pintura-en-altura">Servicio de Pintura en Altura</Link>
            ...
            <div className="header-socials" style={{ display: 'flex', gap: '1rem' }}>
      ...
      <div className={`mobile-drawer ${mobileMenuOpen ? 'active' : ''}`}>
        <div className="mobile-drawer-header" style={{ justifyContent: 'center' }}>
          <img src="/logo_oficial_v3.png" alt="Altura Global Solutions" className="mobile-drawer-logo" />
        </div>
        ...
        <nav className="mobile-drawer-nav">
          ...
          <div className="mobile-nav-accordion">
            ...
            <div className={`mobile-nav-sub ${servicesOpen ? 'active' : ''}`}>
              ...
              <Link href="/servicios/pintura-en-altura" className="mobile-nav-sublink" onClick={closeMenu}>Servicio de Pintura en Altura</Link>
        ...
        <div className="mobile-drawer-footer">
          <Link href="/contacto" className="mobile-drawer-cta" onClick={closeMenu}>
