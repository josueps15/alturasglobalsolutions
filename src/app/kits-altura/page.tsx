...
const PRODUCTS = [
  ...
  },
  {
    ...
    desc: 'Casco dieléctrico de alto impacto con barbiquejo de 4 puntos. Diseño sin visera para facilitar la visión vertical durante trabajos en altura.',
      ...
      <section className="page-hero" style={{ backgroundImage: 'linear-gradient(rgba(11, 19, 32, 0.8), rgba(11, 19, 32, 0.9)), url(/hero-kits-altura.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="page-hero-title">Kits y Equipos para Trabajo en Altura</h1>
            ...
            {PRODUCTS.map((prod, idx) => (
              ...
              >
                <div style={{ height: '240px', overflow: 'hidden', position: 'relative' }}>
                  ...
                  <div style={{ position: 'absolute', top: '15px', right: '15px', background: 'var(--primary-orange)', color: '#fff', padding: '4px 12px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 'bold' }}>
                    Longdyes
                  </div>
                </div>
                <div style={{ padding: '2rem', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                  ...
                  <a 
                    ...
                    style={{ width: '100%', textAlign: 'center', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', padding: '1rem', fontSize: '1.1rem', borderRadius: '8px' }}
                  >
